...
prev: { text: "5. 数据仓库建模：从表设计到分析建模", link: "/chapters/05/" }
next: { text: "06.1 ETL vs ELT", link: "/chapters/06/06-1" }
---
...
| 节号 | 主题 |
|------|------|
| [06.1](/chapters/06/06-1) | ETL vs ELT |
| [06.2](/chapters/06/06-2) | 数据抽取 |
| [06.3](/chapters/06/06-3) | 数据转换 |
| [06.4](/chapters/06/06-4) | 数据加载 |
| [06.5](/chapters/06/06-5) | 常见ETL工具 |
| [06.6](/chapters/06/06-6) | 工作流调度 |
| [06.7](/chapters/06/06-7) | 数据质量监控 |
| [06.8](/chapters/06/06-8) | 错误处理和重试 |
| [06.9](/chapters/06/06-9) | 性能优化 |
| [06.10](/chapters/06/06-10) | ETL最佳实践 |
| [06.11](/chapters/06/06-11) | ELT最佳实践 |
| [06.12](/chapters/06/06-12) | ETL/ELT实战案例 |
