---
title: "06.6 工作流调度"
description: "6.6 工作流调度  上一节学习了常见ETL工具，了解了Airflow、dbt、Airbyte等工具的使用。  ETL任务通常不是单一的，而是有依赖关系的工作流。需要工作流调度工具来管理这些任务。  场景： yaml 数据仓库项目：    "
prev: { text: "06.5 常见ETL工具", link: "/chapters/06/06-5" }
next: { text: "06.7 数据质量监控", link: "/chapters/06/06-7" }
---
### 6.6 工作流调度
