---
title: "06.10 ETL最佳实践"
description: "6.10 ETL最佳实践  前面学习了性能优化，了解了如何优化ETL的各个方面。  现在总结ETL开发的最佳实践，这些实践来自于真实项目的经验总结。  场景： yaml 新数据工程师入职：    新工程师：我刚接手ETL项目，有什么注意事项"
prev: { text: "06.9 性能优化", link: "/chapters/06/06-9" }
next: { text: "06.11 ELT最佳实践", link: "/chapters/06/06-11" }
---
### 6.10 ETL最佳实践
