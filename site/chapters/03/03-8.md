---
title: "03.8 物化视图：把重复计算提前做掉"
description: "3.8 物化视图：把重复计算提前做掉  前几节学习了多种优化手段： - 分区表：通过物理边界优化查询 - 索引：加速数据查找 - 查询优化：分析执行计划，优化查询逻辑  但这些优化都是针对单个查询的。  问题：如果一个复杂查询被频繁执行怎么"
prev: { text: "03.7 查询优化基础：执行计划分析与优化", link: "/chapters/03/03-7" }
next: { text: "03.9 并行查询：利用多核CPU加速大表查询", link: "/chapters/03/03-9" }
---
### 3.8 物化视图：把重复计算提前做掉
