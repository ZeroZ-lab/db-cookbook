---
title: "03.7 查询优化基础：执行计划分析与优化"
description: "3.7 查询优化基础：执行计划分析与优化  前面学习了索引（B-tree、BRIN、GIN、GiST），知道索引能加速查询。  但有两个问题：  问题1：什么时候需要创建索引？ - 创建索引前，如何知道查询慢？ - 如何找出性能瓶颈？  问"
prev: { text: "03.6 索引进阶：BRIN、GIN、GiST与特殊场景", link: "/chapters/03/03-6" }
next: { text: "03.8 物化视图：把重复计算提前做掉", link: "/chapters/03/03-8" }
---
