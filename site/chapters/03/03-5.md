---
title: "03.5 索引基础：B-tree与查询加速"
description: "3.5 索引基础：B-tree与查询加速  前几节讨论了大表性能问题的根本原因：磁盘I/O慢。  解决磁盘I/O慢的核心手段之一是：索引（Index）。  什么是索引？  生活中的索引： - 书的目录：快速找到章节，不用从第一页翻到最后一页"
prev: { text: "03.4 表空间与存储策略：让数据存储更高效", link: "/chapters/03/03-4" }
next: { text: "03.6 索引进阶：BRIN、GIN、GiST与特殊场景", link: "/chapters/03/03-6" }
---
