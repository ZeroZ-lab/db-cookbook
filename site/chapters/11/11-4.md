---
title: "11.4 Neo4j 实战"
description: "11.4 Neo4j 实战  上一节讨论了图查询语言的机制差异。现在用 Neo4j 和 Cypher 把这些机制落到具体的电商反欺诈场景中——不是展示语法糖，而是验证图遍历解决什么、不解决什么的判断。  Neo4j 是原生属性图数据库，从存"
prev: { text: "11.3 图查询语言", link: "/chapters/11/11-3" }
next: { text: "11.5 图数据库架构", link: "/chapters/11/11-5" }
---
### 11.4 Neo4j 实战
