---
title: "02.5 复杂分析SQL：把中间过程表达清楚"
description: "2.5 复杂分析SQL：把中间过程表达清楚  基础查询从单表取数据，聚合分析计算统计指标，多表关联恢复业务事实。  但现实分析往往需要多个步骤：  text 问题：哪个用户复购率最高？  步骤分解： 1. 计算每个用户的订单数 2. 计算每"
prev: { text: "02.4 多表关联：从分散数据中恢复完整业务事实", link: "/chapters/02/02-4" }
next: { text: "02.6 窗口函数：在保留明细的同时做组内分析", link: "/chapters/02/02-6" }
---
