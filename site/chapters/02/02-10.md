---
title: "02.10 SQL在不同系统中的迁移：理解差异，保持能力"
description: "2.10 SQL在不同系统中的迁移：理解差异，保持能力  前面9节学习了SQL的核心能力：查询、聚合、关联、复杂分析、窗口函数、指标计算、性能优化。这些能力是基于PostgreSQL学习的。  但现实世界不止有PostgreSQL。OLTP"
prev: { text: "02.9 SQL性能基础：写出高效的SQL查询", link: "/chapters/02/02-9" }
next: { text: "3. PostgreSQL 大表能力：理解单机数据库边界", link: "/chapters/03/" }
---
