---
title: "07.9 批处理与流处理的融合"
description: "7.9 批处理与流处理的融合  前面学习了批处理系统的设计和实现。  实际场景中，往往需要批处理和流处理结合使用。如何融合批处理和流处理？Lambda架构和Kappa架构如何选择？  场景： yaml 实时数据分析需求：  产品经理：我们需"
prev: { text: "07.8 批处理系统设计", link: "/chapters/07/07-8" }
next: { text: "07.10 批处理最佳实践总结", link: "/chapters/07/07-10" }
---
### 7.9 批处理与流处理的融合
