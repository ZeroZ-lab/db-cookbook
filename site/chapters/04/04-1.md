---
title: "04.1 为什么一个数据库很难同时做好交易和分析"
description: "4.1 为什么一个数据库很难同时做好交易和分析  前3章学习了SQL能力和PostgreSQL大表能力。  但现实业务中，经常遇到一个矛盾：  交易系统和分析系统总是打架。  场景： text 上午9点：运营同学说今天GMV报表怎么这么慢？"
prev: { text: "4. OLTP vs OLAP：大数据系统的第一分水岭", link: "/chapters/04/" }
next: { text: "04.2 从单机到分工：系统的自然演化", link: "/chapters/04/04-2" }
---
