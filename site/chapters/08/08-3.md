---
title: "08.3 流处理核心技术"
description: "8.3 流处理核心技术  上一节学习了实时数据处理的应用场景，了解了实时处理在不同领域的应用。  实时数据处理的核心技术是什么？如何使用这些技术构建实时处理系统？  场景： yaml 实时系统建设：  技术经理：我们要构建实时数据处理系统 "
prev: { text: "08.2 实时数据处理的应用场景", link: "/chapters/08/08-2" }
next: { text: "08.4 流处理架构设计", link: "/chapters/08/08-4" }
---
### 8.3 流处理核心技术
