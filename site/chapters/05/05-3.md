---
title: "05.3 数仓的基本术语"
description: "5.3 数仓的基本术语  维度建模有一套专门的词汇：维度、度量、事实表、维度表、星型模型、雪花模型、粒度。这套词汇不是学院派术语堆砌——每个词对应一个具体的表设计决策。把这些术语搞清楚，动手建数仓时才知道每个字段该放在哪张表里。   维度和"
prev: { text: "05.2 数据仓库的核心概念", link: "/chapters/05/05-2" }
next: { text: "05.4 数仓分层的必要性", link: "/chapters/05/05-4" }
---
### 5.3 数仓的基本术语
