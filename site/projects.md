...
| --- | --- | --- | ---: | ---: |
| PostgreSQL 电商数据分析库 | PostgreSQL 基础与 SQL 分析 | `runtime-entry-present` | 2 | 14 |
| PostgreSQL 到 ClickHouse 分析链路 | OLTP 到 OLAP 分化 | `static-artifacts-verified` | 3 | 14 |
| CDC 实时数仓 Demo | CDC 与实时计算 | `static-artifacts-verified` | 4 | 13 |
| Mini Lakehouse | Lakehouse 架构 | `static-artifacts-verified` | 4 | 13 |
| RAG 向量知识库 | AI 时代数据基础设施 | `static-artifacts-verified` | 3 | 13 |
| 知识图谱与 GraphRAG | 图数据库与 GraphRAG | `static-artifacts-verified` | 3 | 13 |
| 数据治理 Mini Platform | 治理、血缘、质量与信任 | `static-artifacts-verified` | 3 | 13 |
